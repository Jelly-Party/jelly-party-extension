...
export class Vimeo extends Provider{
  ...
  public enterFullScreen() {
    if (this.iFrameTarget) {
      ...
      console.log("Jelly-Party: Vimeo Provider -> enterFullScreen() -> No iFrameTarget found!");
    }
  }
  ...
  public exitFullScreen() {
    if (this.iFrameTarget) {
      ...
      console.log("Jelly-Party: Vimeo Provider -> exitFullScreen() -> No iFrameTarget found!");
    }
  }
  ...
  public contractView() {
    if (this.iFrameTarget) {
      ...
      console.log("Jelly-Party: Vimeo Provider -> contractView() -> No iFrameTarget found!");
    }
  }
  ...
  public expandView() {
    if (this.iFrameTarget) {
      ...
      console.log("Jelly-Party: Vimeo Provider -> expandView() -> No iFrameTarget found!");
    }
  }
}