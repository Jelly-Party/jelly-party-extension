...
let circleBase = "m 256 256";

let arrowToJellyFishInterpolator = interpolate(arrow, jellyfish);
let jellyFishToArrowInterpolator = interpolate(jellyfish, arrow);
let circleToEyeInterpolator = fromCircle(183, 155, 0, eye);
let eyeToCircleInterpolator = toCircle(eye, 183, 155, 0);
let nothingToCircle = toCircle(circleBase, 256, 256, 256);
let circleToNothing = fromCircle(256, 256, 0, circleBase);
