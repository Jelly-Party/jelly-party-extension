      ...
      <g transform="translate(-825.000000, -1100.000000)" id="Avataaar/Circle">
        <g transform="translate(825.000000, 1100.000000)">
          ...
          >
            ...
            <template
              v-if="clotheType !== 'random' && clotheType === 'GraphicShirt'"
            >
              <svg
                :style="cssVars"
                v-html="
            ...
            <template v-else>
              <svg
                v-html="
                  clotheType === 'random'
                    ? getRandomChoice(clothesType)
                    : clothesType[clotheType]
                "
                :style="{ fill: cssVars['--avataaar-shirt-color'] }"
              ></svg>
            </template>
            <svg
              v-html="
                eyeType === 'random'
                  ? getRandomChoice(eyeTypes)
                  : eyeTypes[eyeType]
              "
            ></svg>
            <svg
  ...
  computed: {
    cssVars() {
      return {
        ...
        "--avataaar-hat-color": this.hatAndShirtColors[this.clotheColor],
        "--avataaar-shirt-color": this.hatAndShirtColors[this.clotheColor]
      };
    }
  }
};
